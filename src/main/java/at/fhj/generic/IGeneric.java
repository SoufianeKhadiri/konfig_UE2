...
public interface IGeneric <MyType> {
         ...
         * @return
         */
        public abstract boolean offer(MyType obj);
         ...
         * @return
         */
        public abstract MyType element();
    }
